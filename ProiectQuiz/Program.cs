...
namespace ProiectQuiz
{
    ...
    {
        static List<Categorie> categorii = new List<Categorie>();
        static StocareDataFisier stocare = new StocareDataFisier();

        static void Main()
        {
            // Incarca datele din fisier la pornire
            categorii = stocare.GetCategorii();
        ...
        static void AdaugaCategorie()
        {
            ...
            Categorie categorie = new Categorie(nume, dificultate);
        ...
        static void AdaugaIntrebare()
        {
            ...
            // Salveaza categoria in fisier
            stocare.SalveazaCategorie(categorii[index]);
            Console.WriteLine("Intrebare adaugata si salvata!");
        }
        ...
        static void AfiseazaClasament()
        {
            List<Jucator> clasament = stocare.GetJucatori();
